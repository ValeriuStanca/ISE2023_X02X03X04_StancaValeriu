...
#c #b 6 <td><input type=checkbox name=led6 OnClick="submit();" %s>B</td>
c b 5 <td><input type=checkbox name=led5 OnClick="submit();" %s>B</td>
c b 4 <td><input type=checkbox name=led4 OnClick="submit();" %s>G</td>
#t <td width="5%"></td>
c b 3 <td><input type=checkbox name=led3 OnClick="submit();" %s>R</td>
